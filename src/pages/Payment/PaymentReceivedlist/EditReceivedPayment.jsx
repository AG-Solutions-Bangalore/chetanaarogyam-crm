...
function EditReceivedPayment() {
  ...
  useEffect(() => {
    axios({
      url: BASE_URL + "/api/panel-fetch-payment-by-id/" + id,
      method: "GET",
      headers: {
  ...
  return (
    <Layout>
      <Box bgcolor="#FFFFFF" p={2} borderRadius={2} mt={4}>
        <PageTitle title="Edit Payment" backLink="/p-receivedlist" />
...
export default EditReceivedPayment;
